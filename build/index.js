    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [3 /*break*/, 5];
            case 1:
                if (!!DoesImageExist(exports.input_dir + name)) return [3 /*break*/, 2];
                res.send("Image does not exist");
                return [3 /*break*/, 5];
            case 2:
                out_name = W + "_" + H + "_" + name;
                if (!DoesImageExist(exports.output_dir + out_name)) return [3 /*break*/, 3];
                //use cached image
            ...
            case 3: 
            //resize image  
            return [4 /*yield*/, resize(W, H, name)];
            case 4:
                //resize image  
                _a.sent();
...
function resize(width, height, name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    out_name = width + "_" + height + "_" + name;
                    // resizing image
                    return [4 /*yield*/, (0, sharp_1["default"])(exports.input_dir + name)
                            .resize(width, height)
                            .toFile(exports.output_dir + out_name)];
                case 1:
                    // resizing image
                    _a.sent();
