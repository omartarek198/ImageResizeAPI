...
describe("Tests endpoint response to input", function () {
  it("tests on correct input format", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              request.get("/api?width=100&height=300&name=1.jpg"),
            ];
          case 1:
            response = _a.sent();
...
describe("Tests endpoint response to input", function () {
  it("tests on incorrect input format", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, request.get("/api?width=b&height=300a")];
          case 1:
            response = _a.sent();
...
describe("Tests endpoint response to input", function () {
  it("tests on negative values", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, request.get("/api?width=-300&height=300")];
          case 1:
            response = _a.sent();
            expect(response.text).toBe("error in input");
            console.log(response.text);
...
describe("Testing DoesImageExist function", function () {
  it("Passing a nonexistent image", function () {
    expect(
      (0, index_2.DoesImageExist)(index_3.input_dir + "randomfilename")
    ).toBe(false);
  });
});
